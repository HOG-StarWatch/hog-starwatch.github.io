/**
 * Theme Data - Factory Pattern
 *
 * 使用 createTheme(overrides) 工厂函数消除重复定义。
 * DEFAULT_VARS 定义了 19 个 CSS 自定义属性的默认值，
 * 每个主题只需传入与默认值不同的属性即可。
 * 最终输出的 window.__themeData 与原始版本完全一致。
 */

(function () {
    // 19 个 CSS 自定义属性的默认值（基于暗色主题的常见模式）
    var DEFAULT_VARS = {
        '--bg-deep': '#0b0f19',
    ...
    // 工厂函数：将 overrides 合并到 DEFAULT_VARS 中，生成完整的 vars 对象
