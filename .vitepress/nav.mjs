export default [
    ...
    { text: '网页小工具',
      items: [
        ...
        { text: 'Binary-Waterfall', link: '../../../Binary-Waterfall.html', target: '_self', },
        { text: 'HTML在线运行', link: '../../../html_runner.html', target: '_self', },
        { text: 'HTML在线运行', link: '../../../htmlrunner.html', target: '_self', },
        { text: 'qrcode-decoder', link: '../../../qrcode-decoder.html', target: '_self', },
        { text: '脚本执行器ProMax', link: '../../../ScriptExecutor.html', target: '_self', },
        { text: 'Mp4ToWebP', link: '../../../mp4-to-webp.html', target: '_self', },
